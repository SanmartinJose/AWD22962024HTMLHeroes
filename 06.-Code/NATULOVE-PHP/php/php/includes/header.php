...
<body>
	<div><br>
<center><a class="navbar-brand" href="./indexAdmin.php">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 align-items-center">
          <li class="nav-item"><a href="./indexAdmin.php"><img src="../img/logo.png" width="45" height="45" alt="Logo" class="d-inline-block align-text-top"/></a></li>
