...
<body>
  ...
  <div class="container my-5">
    <center>
      <h1 class="display-4 mb-3 text-danger">NatuLove Productos con Amor</h1>
    </center>
      ...
      <div class="col-md-9">
        <div class="row row-cols-1 row-cols-md-3 g-4">
          ...
          foreach ($products as $product) {
            ...
            $productImage = !empty($productImages) && isset($productImages[0]) ? $productImages[0] : '../img/logo.png';
            echo '
              <div class="col">
                <div class="card h-100">
                  ...
                  <div class="card-body d-flex flex-column">
                    ...
                    <a href="product_detail.php?id=' . $product["id"] . '" class="btn btn-primary mt-2">Más Info</a>
                  </div>
                </div>
              </div>
              ';
        ...
        <nav>
          <ul class="pagination justify-content-center">
            <li class="page-item <?php if ($page == 1)
              echo 'disabled'; ?>">
              <a class="page-link"
                href="?page=<?php echo max(1, $page - 1); ?>&category=<?php echo $category; ?>&search=<?php echo $search; ?>"
                aria-label="Previous">
            ...
            <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
              <li class="page-item <?php if ($i == $page)
                echo 'active'; ?>">
                <a class="page-link"
                  href="?page=<?php echo $i; ?>&category=<?php echo $category; ?>&search=<?php echo $search; ?>"><?php echo $i; ?></a>
              </li>
            <?php } ?>
            <li class="page-item <?php if ($page == $totalPages)
              echo 'disabled'; ?>">
              <a class="page-link"
                href="?page=<?php echo min($totalPages, $page + 1); ?>&category=<?php echo $category; ?>&search=<?php echo $search; ?>"
                aria-label="Next">
